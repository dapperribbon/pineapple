...
FROM (
    SELECT '10.20.0.14'          AS host_input, '2024-11-21 10:03:11' AS created_at, 'mchoo' AS owner
    UNION ALL SELECT 'psa-edi.example.com', '2024-11-21 10:03:48', 'mchoo'
    UNION ALL SELECT '10.20.0.1',           '2024-11-21 10:05:02', 'mchoo'
    UNION ALL SELECT 'dms-staging.internal','2024-11-22 09:41:37', 'jtan'
) AS x
JOIN users u ON u.username = x.owner;
